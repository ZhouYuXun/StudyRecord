...
def main():
    ...
    experiment.set_name(model_name_set + "_b_" + str(hyper_params["batch_size"]) + "_e_" + str(hyper_params["epochs"]) )
    ...
    for epoch in range(hyper_params["epochs"]):
        ...
        # learning_speed change ny val_accurate
        if hyper_params["learning_speed"]:
            learning_rate_rate = max(1/(val_accurate+0.02)*hyper_params["learning_rate"], 15)            
        optimizer.param_groups[0]["lr"] = optimizer.param_groups[0]["lr"] * learning_rate_rate
        learning_rate_params = optimizer.param_groups[0]["lr"]
        ...
        experiment.log_metrics({"learning_rate": learning_rate_params}, epoch=epoch+1)
