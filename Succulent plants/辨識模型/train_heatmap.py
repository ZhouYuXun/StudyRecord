...
def main():
    ...
    exper_mame = "new_lr_{}_{}_{}".format(hyper_params["learning_rate"], "optim.Adam", hyper_params["learning_speed"])
    ...
    for epoch in range(hyper_params["epochs"]):
        ...
        # 上傳到comet
        experiment.log_metrics({"val_accurate": val_accurate, "loss": (running_loss / train_steps)}, epoch=epoch+1)
