...
def main():
    ...
    exper_mame = "new_lr_{}_{}".format(hyper_params["learning_rate"], "optim.SGDM")
    ...
    optimizer = hyper_params["optimizer_name"](params, lr=hyper_params["learning_rate"], momentum=0.9)
